...
![](https://non1.oss-cn-guangzhou.aliyuncs.com/write1/202310241554778.gif)
...
![image-20231024150121487](https://non1.oss-cn-guangzhou.aliyuncs.com/write1/202310241501707.png)
...
![image-20231024152340395](https://non1.oss-cn-guangzhou.aliyuncs.com/write1/202310241523433.png)
...
![image-20231024152956109](https://non1.oss-cn-guangzhou.aliyuncs.com/write1/202310241529068.png)

反向代理，也指的是一台处于客户端和目标服务器之间的代理服务器，客户端对目标服务器进行访问，实际上是对反向代理服务器进行访问，由反向代理服务器对目标服务器进行资源申请，然后将资源返回给客户端。

例如`WWW.baidu.com`,该百度官网实际上是反向代理服务器，我们对百度官网进行资源申请，实际上是由该代理服务器针对不同的资源将客户端的请求分发给内部的服务器，然后由该代理服务器返回客户端相应的资源，我们并不知道内部服务器的IP地址。
...
2. 反向代理常用于Web应用部署中，将客户端的请求分发给多个内部服务器，以实现**负载均衡**和高可用性。
